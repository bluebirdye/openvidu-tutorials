...
public class Session {
    ...
    public PeerConnection createLocalPeerConnection() {
        ...
        PeerConnection.IceServer stunServer = PeerConnection.IceServer.builder("stun:106.52.251.156").createIceServer();
        iceServers.add(stunServer);
        PeerConnection.IceServer turnServer = PeerConnection.IceServer.builder("turn:106.52.251.156").setUsername("username").setPassword("p24sw0rd").createIceServer();
